        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#descripcionModal">?</button>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="descripcion" rows="5" style="font-size: 18px;"></textarea>
                    </div>
                </form>
