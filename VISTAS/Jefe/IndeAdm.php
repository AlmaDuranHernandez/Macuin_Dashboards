...
include '../../VISTAS/General/Cabeceraj.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="col-6">
        <div class="card"> 
            <div class="card-body">
                ...
                <img src="../../GLOBAL/PHOTO/675523.png" alt="">
                <div class="button-container">
                    <a href="../../VISTAS/Jefe/Gestion_departamento.php" class="btn btn-primary" style="color: inherit; text-decoration: none;"> Acceder <i class="bi bi-hand-index"></i></a>
                </div>
            </div>
        </div>
    </div>
