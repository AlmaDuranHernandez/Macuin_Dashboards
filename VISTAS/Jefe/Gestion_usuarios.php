    ...
    <div id="tablaAdministrador" style="display:none;">
        <table>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "</form>";
                    echo "</td>";
                    echo "<td><button class='editar-usuario' data-id='" . $usuario['id'] . " type='button'  data-toggle='modal' data-target='#EditarModal'><i class='bi bi-pencil'></i></button></td>";
                    echo "</tr>";
                }
                ?>
        </table>
    ...
    <div id="tablaAuxiliar" style="display:none;">
        <table>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "</form>";
                echo "</td>";
                echo "<td><button class='editar-usuario' data-id='" . $row['usuario_id'] . " type='button'  data-toggle='modal' data-target='#EditarModal'><i class='bi bi-pencil'></i></button></td>";
                echo "</tr>";
            }
            ?>
        </table>
